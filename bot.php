...
'action'=>'typing'
			        ...
			        Request('sendMessage',[
            			'chat_id'=>$update->message->chat->id,
            			'text'=>'تگ های فارسی :
مشاهده قوانین : #قوانین
راهنما : #راهنما
صفر کردن اخطار(ویژه مدیر) : #اخطار_صفر
بن کردن (ویژه مدیر) : #بن
افزودن اخطار به کاربر (ویژه مدیر) : #اخطار
رفع کردن بن ها و...(ویژه مدیر) : #رفع
اخراج کاربر از گروه (ویژه مدیر) : #اخراج
تعداد اخطار کاربر (ویژه مدیر) : #تعداد_اخطار',
            			'parse_mode'=>'HTML',
            			'parse_mode'=>'HTML',
            			'reply_to_message_id'=>$update->message->message_id,
            			'disable_web_page_preview'=>true
